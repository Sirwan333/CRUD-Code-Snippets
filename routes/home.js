...
router.get('/logout', require('../controllers/loginController').logout)
router.post('/logout', require('../controllers/loginController').logoutPost)
router.get('/delete/:id', require('../controllers/loginController').deleteSnippet)
